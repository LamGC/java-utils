...
public class StringParameterParserMap {
    ...
    private final Hashtable<Type, StringParameterParser<? extends Type>> parserMap = new Hashtable<>();
     ...
     */
    public void addParser(StringParameterParser<? extends Type> parser) throws IllegalModifierException {
        // 获取类型, 检查方法是否为抽象方法.
     ...
     */
    public StringParameterParser<? extends Type> removeParser(Type type) {
     ...
     */
    public StringParameterParser<? extends Type> getParser(Type type) {
